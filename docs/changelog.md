...
- **AI Context Layer**: Machine-readable `docs/ai/` directory for AI agent onboarding.
- **Documentation Website**: VitePress-based site auto-deployed to GitHub Pages.
- **Repository Constitution**: Non-negotiable engineering governance document.
- **Certification Reports**: Evidence-backed architecture and documentation audit reports.
